...
#include "DeathPlane__pf2281100855.h"
...
ADeathPlane_C__pf2281100855::ADeathPlane_C__pf2281100855(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ADeathPlane_C__pf2281100855::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__0->OverrideMaterials = TArray<UMaterialInterface*> ();
		__Local__0->OverrideMaterials.Reserve(1);
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ADeathPlane_C__pf2281100855::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		__Local__2 = FVector(100.000000, 100.000000, 2.000000);
	...
	auto& __Local__5 = (*(AccessPrivateProperty<UStaticMeshComponent*>((this), AStaticMeshActor::__PPO__StaticMeshComponent() )));
...
void ADeathPlane_C__pf2281100855::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ADeathPlane_C__pf2281100855::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__11.ComponentPropertyName = FName(TEXT("StaticMeshComponent"));
	__Local__11.DelegatePropertyName = FName(TEXT("OnComponentHit"));
	__Local__11.FunctionNameToBind = FName(TEXT("BndEvt__StaticMeshComponent_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ADeathPlane_C__pf2281100855::bpf__ExecuteUbergraph_DeathPlane__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsBP_Hero__pf = Cast<ABP_Hero_C__pf3231479144>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBP_Hero__pf != nullptr);;
	...
	{
		b0l__K2Node_DynamicCast_AsBP_Hero__pf->bpf__Death__pf();
	}
	return; // KCST_GotoReturn
}
void ADeathPlane_C__pf2281100855::bpf__BndEvt__StaticMeshComponent_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__HitComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_DeathPlane__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ADeathPlane_C__pf2281100855::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{146, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Engine/BasicShapes/Plane.Plane 
		{147, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Proj/Isometric-Interiors/Meshes/Black.Black 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ADeathPlane_C__pf2281100855::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{148, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.StaticMeshActor 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ADeathPlane_C__pf2281100855
{
	FRegisterHelper__ADeathPlane_C__pf2281100855()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Proj/Placeables/DeathPlane"), &ADeathPlane_C__pf2281100855::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ADeathPlane_C__pf2281100855 Instance;
};
FRegisterHelper__ADeathPlane_C__pf2281100855 FRegisterHelper__ADeathPlane_C__pf2281100855::Instance;
