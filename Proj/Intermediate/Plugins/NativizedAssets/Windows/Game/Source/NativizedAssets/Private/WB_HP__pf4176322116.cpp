...
UWB_HP_C__pf4176322116::UWB_HP_C__pf4176322116(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__Image_50__pf = nullptr;
	bpv__ProgressBar_91__pf = nullptr;
	bpv__Character__pf = nullptr;
	bHasScriptImplementedTick = false;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UWB_HP_C__pf4176322116::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UWB_HP_C__pf4176322116::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__3->LayoutData.Offsets.Right = 512.000000f;
	__Local__3->LayoutData.Offsets.Bottom = 64.000000f;
	__Local__3->Parent = __Local__1;
	auto __Local__4 = NewObject<UImage>(__Local__0, TEXT("Image_50"), (EObjectFlags)0x00280008);
	__Local__4->Brush.ImageSize = FVector2D(256.000000, 32.000000);
	auto& __Local__5 = (*(AccessPrivateProperty<UObject* >(&(__Local__4->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__5 = CastChecked<UObject>(CastChecked<UDynamicClass>(UWB_HP_C__pf4176322116::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__6->LayoutData.Offsets.Left = 76.000000f;
	__Local__6->LayoutData.Offsets.Top = 28.000000f;
	__Local__6->LayoutData.Offsets.Right = 362.399994f;
	__Local__6->LayoutData.Offsets.Bottom = 22.628571f;
	__Local__6->ZOrder = 1;
	__Local__6->Parent = __Local__1;
	auto __Local__7 = NewObject<UProgressBar>(__Local__0, TEXT("ProgressBar_91"), (EObjectFlags)0x00280008);
	__Local__7->WidgetStyle.BackgroundImage.ImageSize = FVector2D(128.000000, 128.000000);
	__Local__7->WidgetStyle.BackgroundImage.Margin.Left = 0.416667f;
	__Local__7->WidgetStyle.BackgroundImage.Margin.Top = 0.416667f;
	__Local__7->WidgetStyle.BackgroundImage.Margin.Right = 0.416667f;
	__Local__7->WidgetStyle.BackgroundImage.Margin.Bottom = 0.416667f;
	auto& __Local__8 = (*(AccessPrivateProperty<UObject* >(&(__Local__7->WidgetStyle.BackgroundImage), FSlateBrush::__PPO__ResourceObject() )));
	__Local__8 = CastChecked<UObject>(CastChecked<UDynamicClass>(UWB_HP_C__pf4176322116::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__7->WidgetStyle.FillImage.Margin.Left = 0.416667f;
	__Local__7->WidgetStyle.FillImage.Margin.Top = 0.416667f;
	__Local__7->WidgetStyle.FillImage.Margin.Right = 0.416667f;
	__Local__7->WidgetStyle.FillImage.Margin.Bottom = 0.416667f;
	__Local__7->BarFillType = EProgressBarFillType::Type::RightToLeft;
	__Local__7->FillColorAndOpacity = FLinearColor(1.000000, 0.000000, 0.000000, 1.000000);
...
PRAGMA_ENABLE_OPTIMIZATION
void UWB_HP_C__pf4176322116::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__9;
	SlotNames.Append(__Local__9);
}
void UWB_HP_C__pf4176322116::InitializeNativeClassData()
{
	...
	__Local__12.ObjectName = FString(TEXT("ProgressBar_91"));
	__Local__12.PropertyName = FName(TEXT("Percent"));
	__Local__12.FunctionName = FName(TEXT("GetPercent_0"));
	...
	__Local__14.Name = FName(TEXT("GetPercent_0"));
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UWB_HP_C__pf4176322116::StaticClass())->MiscConvertedSubobjects[0]), __Local__10, __Local__11);
}
void UWB_HP_C__pf4176322116::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UWB_HP_C__pf4176322116::bpf__ExecuteUbergraph_WB_HP__pf_0(int32 bpp__EntryPoint__pf)
{
...
void UWB_HP_C__pf4176322116::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_WB_HP__pf_0(3);
}
float  UWB_HP_C__pf4176322116::bpf__GetPercent_0__pf()
{
	float bpp__ReturnValue__pf{};
	float bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf{};
	float  __Local__15 = 0.000000;
	bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(((::IsValid(bpv__Character__pf)) ? (bpv__Character__pf->bpv__HP__pf) : (__Local__15)), 100.000000);
	bpp__ReturnValue__pf = bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf;
	return bpp__ReturnValue__pf;
}
PRAGMA_DISABLE_OPTIMIZATION
void UWB_HP_C__pf4176322116::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UWB_HP_C__pf4176322116::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{41, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.ProgressBar 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UWB_HP_C__pf4176322116
{
	FRegisterHelper__UWB_HP_C__pf4176322116()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Proj/Core/UI/WB_HP"), &UWB_HP_C__pf4176322116::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UWB_HP_C__pf4176322116 Instance;
};
FRegisterHelper__UWB_HP_C__pf4176322116 FRegisterHelper__UWB_HP_C__pf4176322116::Instance;
