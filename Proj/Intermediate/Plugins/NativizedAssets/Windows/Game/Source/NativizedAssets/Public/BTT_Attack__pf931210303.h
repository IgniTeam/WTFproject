...
class AAIController;
class APawn;
#include "BTT_Attack__pf931210303.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Proj/Core/AI/BTT_Attack.BTT_Attack_C", OverrideNativeName="BTT_Attack_C"))
class UBTT_Attack_C__pf931210303 : public UBTTask_BlueprintBase
{
public:
	GENERATED_BODY()
	...
	UBTT_Attack_C__pf931210303(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BTT_Attack__pf_0(int32 bpp__EntryPoint__pf);
