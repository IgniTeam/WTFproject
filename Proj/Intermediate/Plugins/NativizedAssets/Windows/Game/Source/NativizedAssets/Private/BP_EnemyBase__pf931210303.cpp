...
ABP_EnemyBase_C__pf931210303::ABP_EnemyBase_C__pf931210303(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	if(__Local__0)
	{
		...
		__Local__0->BodyInstance.bLockZTranslation = true;
	...
	if(__Local__1)
	{
		...
		__Local__1->bImpartBaseVelocityZ = false;
	...
	if(__Local__2)
	{
		...
		__Local__2->SkeletalMesh = CastChecked<USkeletalMesh>(CastChecked<UDynamicClass>(ABP_EnemyBase_C__pf931210303::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__HP__pf = 10.000000f;
	bpv__Reward__pf = nullptr;
	bpv__Baff__pf = E__EBaffs__pf::NewEnumerator0;
	bpv__Damage__pf = 10.000000f;
	...
	AIControllerClass = AC_AI_C__pf931210303::StaticClass();
...
void ABP_EnemyBase_C__pf931210303::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_EnemyBase_C__pf931210303::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AC_AI_C__pf931210303::StaticClass());
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_EnemyBase_C__pf931210303::bpf__ExecuteUbergraph_BP_EnemyBase__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 17:
			{
				...
				bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(bpfv__CallFunc_GetPlayerCharacter_ReturnValue_1__pf, bpv__Damage__pf, ((AController*)nullptr), this, ((UClass*)nullptr));
			}
		case 18:
			{
		...
		case 19:
			{
				UGameplayStatics::PlaySound2D(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(ABP_EnemyBase_C__pf931210303::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed), 1.000000, 1.000000, 0.000000, ((USoundConcurrency*)nullptr), ((AActor*)nullptr), true);
			}
		case 20:
			{
				UKismetSystemLibrary::Delay(this, 0.500000, FLatentActionInfo(11, -1390739426, TEXT("ExecuteUbergraph_BP_EnemyBase_0"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 21:
...
void ABP_EnemyBase_C__pf931210303::bpf__ExecuteUbergraph_BP_EnemyBase__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bool bpfv__CallFunc_RandomBoolWithWeight_ReturnValue__pf{};
	int32 __CurrentState = bpp__EntryPoint__pf;
	do
	{
		switch( __CurrentState )
		...
		case 31:
			{
				...
				{
					(*(AccessPrivateProperty<USkeletalMeshComponent* >((this), ACharacter::__PPO__Mesh() )))->SetCollisionEnabled(ECollisionEnabled::QueryAndPhysics);
				}
			}
		case 32:
			{
		...
		case 36:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsGM_Main__pf))
				{
					b0l__K2Node_DynamicCast_AsGM_Main__pf->bpf__RemoveEnemy__pf();
				}
			}
		case 37:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, bpv__Reward__pf, b0l__CallFunc_GetTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, ((AActor*)nullptr));
			}
		case 38:
			{
				b0l__CallFunc_GetTransform_ReturnValue__pf = AActor::GetTransform();
		...
		case 40:
			{
				bpfv__CallFunc_RandomBoolWithWeight_ReturnValue__pf = UKismetMathLibrary::RandomBoolWithWeight(0.250000);
				if (!bpfv__CallFunc_RandomBoolWithWeight_ReturnValue__pf)
				{
					__CurrentState = 44;
					break;
				}
		...
		case 42:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsBP_Hero__pf))
				{
					b0l__K2Node_DynamicCast_AsBP_Hero__pf->bpf__BuffHero__pf(bpv__Baff__pf);
				}
			}
		case 43:
			{
				UKismetSystemLibrary::Delay(this, 5.000000, FLatentActionInfo(9, 1424003765, TEXT("ExecuteUbergraph_BP_EnemyBase_1"), this));
				__CurrentState = -1;
				break;
			}
		case 44:
			{
				bpv__Baff__pf = E__EBaffs__pf::NewEnumerator2;
				__CurrentState = 42;
				break;
			}
		default:
...
void ABP_EnemyBase_C__pf931210303::bpf__ExecuteUbergraph_BP_EnemyBase__pf_2(int32 bpp__EntryPoint__pf)
{
...
void ABP_EnemyBase_C__pf931210303::bpf__Death__pf()
{
	bpf__ExecuteUbergraph_BP_EnemyBase__pf_1(30);
}
void ABP_EnemyBase_C__pf931210303::bpf__ReceiveAnyDamage__pf(float bpp__Damage__pf, const UDamageType* bpp__DamageType__pf__const, AController* bpp__InstigatedBy__pf, AActor* bpp__DamageCauser__pf)
{
	...
	bpf__ExecuteUbergraph_BP_EnemyBase__pf_2(27);
}
void ABP_EnemyBase_C__pf931210303::bpf__Attack__pf()
{
	bpf__ExecuteUbergraph_BP_EnemyBase__pf_0(26);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_EnemyBase_C__pf931210303::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_EnemyBase_C__pf931210303::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{141, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Proj/Core/AI/BPI_Interaction.BPI_Interaction_C 
		...
		{142, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  AnimBlueprintGeneratedClass /Game/Mannequin/Animations/ThirdPerson_AnimBP.ThirdPerson_AnimBP_C 
		{143, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Proj/Core/AI/C_AI.C_AI_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_EnemyBase_C__pf931210303
{
	FRegisterHelper__ABP_EnemyBase_C__pf931210303()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Proj/Core/AI/BP_EnemyBase"), &ABP_EnemyBase_C__pf931210303::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_EnemyBase_C__pf931210303 Instance;
};
FRegisterHelper__ABP_EnemyBase_C__pf931210303 FRegisterHelper__ABP_EnemyBase_C__pf931210303::Instance;
