...
#include "PC_Main__pf3231479144.h"

#include "BP_Elevator__pf350680655.h"
...
AGM_Main_C__pf3231479144::AGM_Main_C__pf3231479144(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	bpv__PreviousLevel__pf = FName();
	bpv__Levels__pf = TArray<FName> ();
	bpv__Levels__pf.Reserve(2);
	bpv__Levels__pf.Add(FName(TEXT("Var1")));
	bpv__Levels__pf.Add(FName(TEXT("Var2")));
	bpv__BossCounter__pf = 1;
	bpv__EnemiesCount__pf = 0;
	bpv__NeededItems__pf = TArray<UClass*> ();
	bpv__CurrentLevels__pf = TArray<FName> ();
	bpv__LoadingWidget__pf = nullptr;
	bpv__Character__pf = nullptr;
	PlayerControllerClass = APC_Main_C__pf3231479144::StaticClass();
	DefaultPawnClass = ABP_Hero_C__pf3231479144::StaticClass();
...
void AGM_Main_C__pf3231479144::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AGM_Main_C__pf3231479144::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(APC_Main_C__pf3231479144::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void AGM_Main_C__pf3231479144::bpf__ExecuteUbergraph_GM_Main__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpv__EnemiesCount__pf, 1);
	bpv__EnemiesCount__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
	float  __Local__3 = 0.000000;
	bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(((::IsValid(bpv__Character__pf)) ? (bpv__Character__pf->bpv__SuperShot__pf) : (__Local__3)), 1.000000);
	if(::IsValid(bpv__Character__pf))
	{
		bpv__Character__pf->bpv__SuperShot__pf = bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf;
	}
	bpfv__CallFunc_LessEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::LessEqual_IntInt(bpv__EnemiesCount__pf, 0);
	...
	UGameplayStatics::GetAllActorsOfClass(this, CastChecked<UClass>(CastChecked<UDynamicClass>(AGM_Main_C__pf3231479144::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), /*out*/ b0l__CallFunc_GetAllActorsOfClass_OutActors_1__pf);
	...
	{
		FUnconvertedWrapper__ABP_Elevator_C__pf350680655(b0l__CallFunc_Array_Get_Item_1__pf).bpf__LiftDown__pf();
	}
	return; //KCST_EndOfThread
}
void AGM_Main_C__pf3231479144::bpf__ExecuteUbergraph_GM_Main__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 2:
			{
				FCustomThunkTemplates::Array_Get(bpv__CurrentLevels__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item_2__pf);
				bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(bpv__CurrentLevels__pf, b0l__CallFunc_Array_Get_Item_2__pf);
			}
		case 3:
			{
		...
		case 4:
			{
				...
				if(::IsValid(bpfv__CallFunc_GetPlayerCharacter_ReturnValue_1__pf))
				{
					bpfv__CallFunc_K2_SetActorLocation_ReturnValue__pf = bpfv__CallFunc_GetPlayerCharacter_ReturnValue_1__pf->AActor::K2_SetActorLocation(bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetActorLocation_SweepHitResult__pf, false);
				}
			}
		case 5:
			{
				UKismetSystemLibrary::Delay(this, 3.000000, FLatentActionInfo(6, 425237631, TEXT("ExecuteUbergraph_GM_Main_1"), this));
		...
		case 7:
			{
				...
				{
					b0l__CallFunc_Create_ReturnValue__pf->RemoveFromParent();
				}
			}
		case 8:
			{
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpv__CurrentLevels__pf);
		...
		case 13:
			{
				...
				UGameplayStatics::GetAllActorsOfClass(this, ABP_EnemyBase_C__pf931210303::StaticClass(), /*out*/ TArrayCaster<ABP_EnemyBase_C__pf931210303*>(b0l__CallFunc_GetAllActorsOfClass_OutActors_2__pf).Get<AActor*>());
			}
		case 14:
			{
		...
		case 16:
			{
				bpfv__CallFunc_Array_Length_ReturnValue_1__pf = FCustomThunkTemplates::Array_Length(b0l__CallFunc_GetAllActorsOfClass_OutActors_2__pf);
		...
		case 19:
			{
				FCustomThunkTemplates::Array_Get(b0l__CallFunc_GetAllActorsOfClass_OutActors_2__pf, b0l__Temp_int_Array_Index_Variable__pf, /*out*/ b0l__CallFunc_Array_Get_Item_3__pf);
				if(::IsValid(b0l__CallFunc_Array_Get_Item_3__pf))
				{
					b0l__CallFunc_Array_Get_Item_3__pf->K2_DestroyActor();
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 21:
			{
				bpfv__CallFunc_EqualEqual_NameName_ReturnValue__pf = UKismetMathLibrary::EqualEqual_NameName(b0l__K2Node_CustomEvent_LevelToLoad__pf, FName(TEXT("None")));
		...
		case 22:
			{
				FCustomThunkTemplates::Array_Shuffle(bpv__CurrentLevels__pf);
			}
		case 23:
			{
				FCustomThunkTemplates::Array_Get(bpv__CurrentLevels__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item_2__pf);
				bpv__PreviousLevel__pf = b0l__CallFunc_Array_Get_Item_2__pf;
			}
		case 24:
			{
				FCustomThunkTemplates::Array_Get(bpv__CurrentLevels__pf, 0, /*out*/ b0l__CallFunc_Array_Get_Item_2__pf);
				UGameplayStatics::LoadStreamLevel(this, b0l__CallFunc_Array_Get_Item_2__pf, true, false, FLatentActionInfo(1, 1927557407, TEXT("ExecuteUbergraph_GM_Main_1"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 25:
			{
				UGameplayStatics::LoadStreamLevel(this, b0l__K2Node_CustomEvent_LevelToLoad__pf, true, false, FLatentActionInfo(26, -1796825564, TEXT("ExecuteUbergraph_GM_Main_1"), this));
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 26:
		...
		case 27:
			{
				bpv__PreviousLevel__pf = b0l__K2Node_CustomEvent_LevelToLoad__pf;
				__CurrentState = 3;
				break;
			}
		case 28:
		...
		case 32:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__LoadingWidget__pf);
		...
		case 33:
			{
				if(::IsValid(bpv__LoadingWidget__pf))
				{
					bpfv__CallFunc_IsInViewport_ReturnValue__pf = bpv__LoadingWidget__pf->UUserWidget::IsInViewport();
				}
		...
		case 34:
			{
				if(::IsValid(bpv__LoadingWidget__pf))
				{
					bpv__LoadingWidget__pf->RemoveFromParent();
				}
			}
		case 35:
			{
				UGameplayStatics::UnloadStreamLevel(this, bpv__PreviousLevel__pf, FLatentActionInfo(12, -1688707489, TEXT("ExecuteUbergraph_GM_Main_1"), this), false);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 36:
			{
				b0l__CallFunc_Create_ReturnValue__pf = CastChecked<UWB_Loading_C__pf4176322116>(UWidgetBlueprintLibrary::Create(this, UWB_Loading_C__pf4176322116::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
			}
		case 37:
			{
				bpv__LoadingWidget__pf = b0l__CallFunc_Create_ReturnValue__pf;
			}
		case 38:
			{
				if(::IsValid(b0l__CallFunc_Create_ReturnValue__pf))
...
void AGM_Main_C__pf3231479144::bpf__ExecuteUbergraph_GM_Main__pf_2(int32 bpp__EntryPoint__pf)
{
...
void AGM_Main_C__pf3231479144::bpf__ExecuteUbergraph_GM_Main__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 47);
	// optimized KCST_UnconditionalGoto
	FCustomThunkTemplates::Array_Clear(bpv__CurrentLevels__pf);
	bpv__CurrentLevels__pf = bpv__Levels__pf;
	return; //KCST_EndOfThread
}
void AGM_Main_C__pf3231479144::bpf__ExecuteUbergraph_GM_Main__pf_4(int32 bpp__EntryPoint__pf)
{
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 45);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__EnemiesCount__pf, 1);
	bpv__EnemiesCount__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	return; //KCST_EndOfThread
}
void AGM_Main_C__pf3231479144::bpf__ReloadLevels__pf()
{
	bpf__ExecuteUbergraph_GM_Main__pf_3(47);
}
void AGM_Main_C__pf3231479144::bpf__AddEnemy__pf()
{
	bpf__ExecuteUbergraph_GM_Main__pf_4(45);
}
void AGM_Main_C__pf3231479144::bpf__RemoveEnemy__pf()
{
	bpf__ExecuteUbergraph_GM_Main__pf_0(41);
}
void AGM_Main_C__pf3231479144::bpf__LoadLevel__pf(FName bpp__LevelToLoad__pf)
{
	b0l__K2Node_CustomEvent_LevelToLoad__pf = bpp__LevelToLoad__pf;
	bpf__ExecuteUbergraph_GM_Main__pf_1(31);
}
void AGM_Main_C__pf3231479144::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_GM_Main__pf_2(29);
}
PRAGMA_DISABLE_OPTIMIZATION
void AGM_Main_C__pf3231479144::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AGM_Main_C__pf3231479144::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{81, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.GameModeBase 
		...
		{144, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Proj/Core/PC_Main.PC_Main_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AGM_Main_C__pf3231479144
{
	FRegisterHelper__AGM_Main_C__pf3231479144()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Proj/Core/GM_Main"), &AGM_Main_C__pf3231479144::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AGM_Main_C__pf3231479144 Instance;
};
FRegisterHelper__AGM_Main_C__pf3231479144 FRegisterHelper__AGM_Main_C__pf3231479144::Instance;
